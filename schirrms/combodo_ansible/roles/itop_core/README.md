...
| itop_core_ws_ansible_inventory | False | str | ANS_ITOP_DEV |  | Name of the inventory to consider |
| itop_core_read_obj_class | True | str |  |  | Class of CI to read |
| itop_core_read_key | True | str |  |  | Set of attributes to be used for the reconciliation |
...
| itop_core_write_key | True | str |  |  | Set of attributes to be used for the reconciliation |
...
| itop_core_ispresent_key | True | str |  |  | Set of attributes to be used for the reconciliation |
